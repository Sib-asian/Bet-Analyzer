...
st.title("⚽ Modello Scommesse – versione con The Odds API PRO")
...
with col_co3:
    ...
    odds_btts = st.number_input("Quota GG (BTTS sì) – se ce l’hai tu", value=1.95, step=0.01)

st.subheader("3.b Quote Over/Under 2.5")
